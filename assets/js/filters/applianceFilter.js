...
//     });
//     appliancesDropdown.appendChild(dropdownMenu);
//     const dropdownArrow = document.querySelector('.dropdown-arrow.appliance');
//     dropdownArrow.addEventListener('click', function () {
//         dropdownMenu.classList.toggle('show');
//         document.querySelector('.btn-ingredients .dropdown-menu').classList.remove('show'); // Masquer le menu déroulant des ingrédients
//     });
// }
